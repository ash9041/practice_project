...
import zero_icon from '../Assets/circle.png'
let data = ["", "", "", "", "", "", "", "", ""];


const TicTacToe = (e,num) => {
    ...
    const checkwin = () => {
        ...
        else if (data[7] ===data[8] && data[8] ===data[6] && data[6] !== "") {
            won(data[7]);
        }
        else if (data[0] ===data[3] && data[6] === data[3] && data[6] !== "") {
            won(data[0]);
        }
    ...
    const won = (winner) => {
        ...
        if (winner === "x") {
            ...
            titleRef.current.innerHTML = `congratulation : <img src='${zero_icon}'>won`;
        }
